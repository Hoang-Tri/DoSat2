        ...
        <div class="row row-cols-5 row-cols-lg-2 row-cols-sm-1 g-3">
            ...
            <div class="col">
                <article class="product-card">
                    <div class="product-card__img-wrap">
                        <a href="<?php echo BASE_URL ?>/product-detail.html">
                            <img src="<?php echo BASE_URL ?>/assets/img/product/item-2.png" alt="" class="product-card__thumb" />
                        </a>
                        <button class="like-btn product-card__like-btn">
                            <img src="<?php echo BASE_URL ?>/assets/icons/hearth.svg" alt="" class="like-btn__icon icon" />
                            <img src="<?php echo BASE_URL ?>/assets/icons/hearth-red.svg" alt="" class="like-btn__icon--liked" />
                    ...
                    <h3 class="product-card__title">
                        <a href="#!">Lavazza Coffee Blends - Try the Italian Espresso Lavazza </a>
                    </h3>
                    <h4 class="product-card__brand">Lavazza</h4>
                    <div class="product-card__row">
            ...
            <div class="col">
                <article class="product-card">
                    <div class="product-card__img-wrap">
                        <a href="<?php echo BASE_URL ?>/product-detail.html">
                            <img src="<?php echo BASE_URL ?>/assets/img/product/item-3.png" alt="" class="product-card__thumb" />
                        </a>
                    ...
                    <h4 class="product-card__brand">welikecoffee</h4>
                    <div class="product-card__row">
            ...
            <div class="col">
                <article class="product-card">
                    <div class="product-card__img-wrap">
                        <a href="<?php echo BASE_URL ?>/product-detail.html">
                            <img src="<?php echo BASE_URL ?>/assets/img/product/item-4.png" alt="" class="product-card__thumb" />
                        </a>
                        <button class="like-btn like-btn__liked product-card__like-btn">
                            <img src="<?php echo BASE_URL ?>/assets/icons/hearth-red.svg" alt="" class="like-btn__icon--liked" />
                            <img src="<?php echo BASE_URL ?>/assets/icons/hearth.svg" alt="" class="like-btn__icon icon" />
